  ...
  return (
    <div>
      <div className="landing-page">
        <img
          className="rosecliff-photo"
          src={rosecliff}
          alt="rosecliff mansion"
        ></img>
        <div className="names">
        ...
        <div className="landing-page-details">
          <div className="date-details">
            <div className="day-details">
              <h2 className="day">December 10</h2>
              <h3 className="year">2021</h3>
            </div>
            <div className="location-details">
              <h2 className="city">Newport</h2>
              <h3 className="state">Rhode Island</h3>
            </div>
          </div>
        </div>
