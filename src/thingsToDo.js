          ...
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://www.newportmansions.org/">
                  View
                </a>
              </button>
            </div>
        ...
        <div className="right-column">
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://www.cityofnewport.com/">
                  View
                </a>
              </button>
            </div>
          ...
          <div className="details">
            ...
            <div className="contact">
              <button className="map-btn">
                <a
                  target="_blank"
                  href="https://www.google.com/maps?q=Thames+St,+Newport,+RI+02840,+USA&ftid=0x89e5af6651095f6f:0x7dbb4f27199baafb"
                >
                  View
                </a>
              </button>
          ...
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a
                  target="_blank"
                  href="https://www.google.com/maps?cid=18346764038762742064"
                >
                  View
                </a>
              </button>
        ...
        <div className="left-column">
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://sightsailing.com/">
                  View
                </a>
              </button>
            </div>
        ...
        <div className="right-column">
          <div className="details">
            <div className="things-to-do-img">
              <img
                className="img"
                src={tennisHallOfFame}
                alt="tennis hall of fame"
              ></img>
            </div>
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://www.tennisfame.com/">
                  View
                </a>
              </button>
            </div>
        ...
        <div className="left-column">
          <div className="details">
            <div className="things-to-do-img">
              <img
                className="img"
                src={newportArtMuseum}
                alt="Newport Art Museum"
              ></img>
            </div>
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://newportartmuseum.org/">
                  View
                </a>
              </button>
            </div>
        ...
        <div className="right-column">
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://sailnewport.org/">
                  View
                </a>
              </button>
            </div>
        ...
        <div className="left-column">
          <div className="details">
            <div className="things-to-do-img">
              <img
                className="img"
                src={newportvineyards}
                alt="Newport Vineyards"
              ></img>
            </div>
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://www.newportvineyards.com/">
                  View
                </a>
              </button>
            </div>
        ...
        <div className="right-column">
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="http://www.redwoodlibrary.org/">
                  View
                </a>
              </button>
            </div>
        ...
        <div className="left-column">
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://www.trinitynewport.org/">
                  View
                </a>
              </button>
            </div>
          ...
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a
                  target="_blank"
                  href="https://www.cityofnewport.com/en-us/visiting-newport/eastons-beach"
                >
                  View
                </a>
              </button>
          ...
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a
                  target="_blank"
                  href="http://www.riparks.com/Locations/LocationFortAdams.html"
                >
                  View
                </a>
              </button>
        ...
        <div className="right-column">
          <div className="details">
            ...
            <div className="contact">
              ...
              <button className="map-btn">
                <a target="_blank" href="https://bowenswharf.com/">
                  View
                </a>
              </button>
            </div>
